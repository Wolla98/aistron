...
def _get_coco_instances_meta(cat_list):
...
def register_coco(root):
    register_aistron_cocolike_instances("coco_train", _get_coco_instances_meta(COCO_CATEGORIES),
        join(root, "coco/annotations/instances_train2017_aistron.json"),
        join(root, "coco/train2017/")
    )

    register_aistron_cocolike_instances("coco_val", _get_coco_instances_meta(COCO_CATEGORIES),
        join(root, "coco/annotations/instances_val2017_aistron.json"),
